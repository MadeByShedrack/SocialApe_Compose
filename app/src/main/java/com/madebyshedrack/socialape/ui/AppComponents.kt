...
fun TopBar(value: String){
    Row(
        ...
        Image(
            ...
            contentDescription = "SocialApe Picture",
...
@Composable
fun GenderCard(image: Int, selected: Boolean, selectGender: (animalName: String) -> Unit){
    ...
    Card(
        ...
        Box(
            ...
            Image(
                ...
                contentDescription = "girl picture",
                modifier = Modifier
                    .padding(16.dp)
                    .wrapContentWidth()
                    .wrapContentHeight()
                    .clickable {
                        val animalName = if (image == R.drawable.girl) "Female" else "Male"
                        selectGender(animalName)
...
fun ButtonComponent(
    ...
    Button(
        ...
        TextComponent(
            textValue = "Go To Profile Screen",
            textSize = 18.sp,
